Ext.define('Klickakart.view.smartdevice.reportview.dataview.DataView', {
	extend : 'Ext.panel.Panel',
	requires:['Klickakart.view.smartdevice.reportview.dataview.DataViewController','Klickakart.view.smartdevice.reportview.dataview.DataDetailViewModel'],
