Ext.define('Klickakart.view.smartdevice.reportview.querycriteria.QueryCriteria', {
	extend : 'Ext.panel.Panel',
	requires:['Klickakart.view.smartdevice.reportview.querycriteria.QueryCriteriaController'],
