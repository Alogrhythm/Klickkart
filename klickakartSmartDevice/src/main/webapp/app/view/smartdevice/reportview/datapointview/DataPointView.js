Ext.define('Klickakart.view.smartdevice.reportview.datapointview.DataPointView', {
	extend : 'Ext.panel.Panel',
	requires:['Klickakart.view.smartdevice.reportview.datapointview.DataPointViewController'],
