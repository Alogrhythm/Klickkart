Ext.define('Klickakart.view.smartdevice.reportview.querycriteria.QueryCriteriaController',{
	extend :'Klickakart.view.smartdevice.reportview.ReportMainViewController',
	alias:'controller.report-querycriteriaview',
	onApplyCriteriaBtnClick : function(){
		var sender = this;
		var reportmainview = sender.view.up('report-mainview');
	...
	defineQueryCriteriaUI : function(queryCwid_json){
		...
		var reportmainview = this.view.up('report-mainview');
