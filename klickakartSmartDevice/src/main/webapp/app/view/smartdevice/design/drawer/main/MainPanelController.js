Ext.define('Klickakart.view.smartdevice.design.drawer.main.MainPanelController', {
    ...
    onSmartSearchClick: function(smartSearchBtn)
    {
        var appMainTabPanel = Ext.getCmp('appMainTabPanel');
    	appMainTabPanel.removeAll();
    	appMainTabPanel.add({xtype:'search-engine-main-view'});
    	var centerPanel =  Ext.getCmp('centerPanel');
    ...
    onLogoutMenuItemClick :function( item, e, eOpts ){
            ...
            Ext.Ajax.request({
                ...
                success : function(response, scope) {
                    ...
                    mainViewport.add(Ext.create('Klickakart.view.smartdevice.login.Login'));
