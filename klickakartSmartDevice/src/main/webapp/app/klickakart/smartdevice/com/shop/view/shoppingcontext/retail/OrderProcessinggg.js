Ext.define('Klickakart.klickakart.smartdevice.com.shop.view.shoppingcontext.retail.OrderProcessinggg', {
     "xtype": "orderProcessinggg",
     "name": "orderProcess",
     "items": [{
          "xtype": "panel",
          "items": [{
          ...
          "columns": [{
               ...
               "tpl": "<div><div align='left' style='margin-right: 2em;'><b>Quantity :<\/b> {qty}<\/div><div align='left' style='margin-right: 2em;'><b>Sub Total :<\/b> {subTotal}<\/div><div align='left' style='margin-right: 2em;'><b>Item :<\/b> {itemName}<\/div><div align='left' style='margin-right: 2em;'><b>Stock :<\/b> {itemStock}<\/div><div align='left' style='margin-right: 2em;'><b>Cost :<\/b> {itemPrice}<\/div><\/div>",
               "flex": 1
          }],
          "height": 300,
          ...
          "store": {
               ...
               "proxy": {
                    "type": "ajax",
                    "url": AppRestUrl+"secure/FetchCartItemsWS/fetchCartItems",
     ...
     "margin": 5,
     "dockedItems": [],
     "itemId": "orderProcess_orderProcessinggg",
     "requires": ["Klickakart.klickakart.shared.com.shop.model.shoppingcontext.FetchCartItemsModel", "Klickakart.klickakart.smartdevice.com.shop.controller.shoppingcontext.retail.OrderProcessingggController", "Klickakart.klickakart.shared.com.shop.viewmodel.shoppingcontext.retail.OrderProcessingggViewModel", "Klickakart.klickakart.shared.com.shop.model.shoppingcontext.retail.OrderProcessingggModel", "Klickakart.view.fw.component.Grids"],
     "extend": "Ext.form.Panel",
     "listeners": {
          "afterrender": "onOrderProcessAfterrender",
          "scope": "controller"
     },
     "viewModel": "OrderProcessingggViewModel",
     "controller": "OrderProcessingggController"
});