 ...
 * 
 */
Ext.define('Klickakart.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Klickakart.view.securityconfig.SecurityConfigController',
			'Klickakart.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
