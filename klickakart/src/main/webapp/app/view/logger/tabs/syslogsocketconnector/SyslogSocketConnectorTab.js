 ...
 * 
 */
Ext.define('Klickakart.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Klickakart.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
