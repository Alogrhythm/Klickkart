...
Ext
		.define(
				'Klickakart.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Klickakart.view.logger.tabs.details.DetailsTab',
							'Klickakart.view.logger.tabs.fileconnector.FileConnectorTab',
							'Klickakart.view.logger.tabs.dbconnector.DBConnectorTab',
							'Klickakart.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Klickakart.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Klickakart.view.logger.LogConfigurationTabPanelController',
