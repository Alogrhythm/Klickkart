Ext.define('Klickakart.view.desktop.design.menubar.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Klickakart.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Klickakart.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Klickakart.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Klickakart.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Klickakart.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Klickakart.view.clouddrive.CloudDrive");
    },
    ...
    onLogoutClick : function(logoutBtn)
    {
     ...
     onSearchClick : function(searchBtn){
         ...
         var searchView = this.pushViewInMainTab("Klickakart.view.searchengine.search.SearchEngineMainPanel","Search Result","isSearchCmp","true");
