 ...
 * 
 */
Ext.define("Klickakart.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Klickakart.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
