Ext
		.define(
				'Klickakart.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Klickakart.view.searchengine.search.SearchEngineMainPanelController','Klickakart.view.searchengine.search.PanelHeaderField' ,'Klickakart.view.searchengine.search.ReportGridView','Klickakart.view.searchengine.search.ReportChartView','Klickakart.view.searchengine.search.documentView','Klickakart.view.searchengine.search.DouMeanView','Klickakart.view.googlemaps.map.MapPanel'],
