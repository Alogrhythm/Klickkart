Ext.define('Klickakart.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Klickakart.view.searchengine.search.NorthPanel', 'Klickakart.view.searchengine.search.SearchResult','Klickakart.view.searchengine.search.SearchEngineMainPanelController'],
