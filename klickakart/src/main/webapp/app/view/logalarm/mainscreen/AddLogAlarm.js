 ...
 * 
 */
Ext.define('Klickakart.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Klickakart.view.logalarm.mainscreen.AddLogAlarmController',
			'Klickakart.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Klickakart.view.logalarm.mainscreen.AppAlarmPanel',
