Ext.define('Klickakart.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Klickakart.view.usermanagement.admin.AddUserDetailsViewModel', 'Klickakart.model.AddUserDataModel' ],
