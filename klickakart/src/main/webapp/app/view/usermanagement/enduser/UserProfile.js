Ext.define('Klickakart.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Klickakart.view.usermanagement.enduser.UserProfileController', 'Klickakart.view.usermanagement.admin.AddUserDetailsViewModel', 'Klickakart.model.AddUserDataModel' ],
