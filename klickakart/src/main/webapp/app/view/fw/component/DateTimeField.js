 ...
 */
Ext.define('Klickakart.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Klickakart.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Klickakart.view.fw.component.DateTimePicker(o);
    },
