...
folder are mapped to the application's root namespace, 'Klickakart'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "Klickakart"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Klickakart' in the same way
as `"Klickakart/sass/src"`.
