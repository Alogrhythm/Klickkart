package com.shop.app.config.appSetup.xmlParser;import java.io.BufferedInputStream;
 ...
 * 
 * 		mco = (MyCustomObject) parser.parse(new File(
 * 				&quot;/usr/home/data/xmlfile.xml&quot;));
 * 
 * 		// OR Parse XML from a File
 * 
...
public abstract class AbstractSAXParser extends DefaultHandler {
	 ...
	 * @throws SAXParserException
	 */
	public final Object parseFile(String _fileName) throws SAXParserException {
		if (_fileName == null) {
			throw new SAXParserException("Invalid file=[" + _fileName + "]");
		}
		return parse(new File(_fileName));
	}
}
