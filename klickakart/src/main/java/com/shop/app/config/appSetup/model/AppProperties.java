package com.shop.app.config.appSetup.model;
public final class AppProperties {
	...
	public AppProperties(
			String searchEngineDocResultFields,
			String searchengineSearchLanguage, int authenticationType,
			String ldapDomain, String ldapUrl, String baseProjectUrl) {
		super();
	...
	public String toString() {
		return "AppProperties [searchEngineDocResultFields=" + searchEngineDocResultFields + ", searchengineSearchLanguage=" + searchengineSearchLanguage
				+ ", authenticationType=" + authenticationType + ", ldapDomain=" + ldapDomain + ", ldapUrl=" + ldapUrl + ", baseProjectUrl=" + solrProjectUrl + "]";
	}
