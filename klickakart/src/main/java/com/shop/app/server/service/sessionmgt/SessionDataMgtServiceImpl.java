package com.shop.app.server.service.sessionmgt;
import com.shop.app.server.businessservice.appbasicsetup.aaa.CookieValidation;
...
public void setSessionAttributeForObject(String key, Object value) {
	...
	private void updateSession(LoginSessionInterface loginSession, String sessionData) throws Exception{
