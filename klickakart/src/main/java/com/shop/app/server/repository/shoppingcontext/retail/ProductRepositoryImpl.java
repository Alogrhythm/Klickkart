...
@Repository
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for Product Master table Entity", complexity = Complexity.LOW)
public class ProductRepositoryImpl extends SearchInterfaceImpl implements ProductRepository<Product> {
    ...
    public List<Product> findAll() throws Exception {
        ...
        java.util.List<com.shop.app.shared.shoppingcontext.retail.Product> query = emanager.createQuery("select u from Product u where u.systemInfo.activeStatus=1").getResultList();
        Log.out.println("SHPRT324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ProductRepositoryImpl", "findAll", "Total Records Fetched = " + query.size());
        return query;
    }
    ...
    public Product save(Product entity) throws Exception {
        ...
        Log.out.println("SHPRT322100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ProductRepositoryImpl", "save", entity);
        return entity;
    }
    ...
    public List<Product> save(List<Product> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.shop.app.shared.shoppingcontext.retail.Product obj = entity.get(i);
            emanager.persist(obj);
        }
        Log.out.println("SHPRT322100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ProductRepositoryImpl", "saveAll", "Total Records saved = " + entity.size());
        return entity;
    }
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.shop.app.shared.shoppingcontext.retail.Product s = emanager.find(com.shop.app.shared.shoppingcontext.retail.Product.class, id);
        emanager.remove(s);
        Log.out.println("SHPRT328100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ProductRepositoryImpl", "delete", "Record Deleted");
    }
    ...
    public void update(Product entity) throws Exception {
        ...
        Log.out.println("SHPRT321100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ProductRepositoryImpl", "update", entity);
    }
    ...
    public void update(List<Product> entity) throws Exception {
        ...
        Log.out.println("SHPRT321100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ProductRepositoryImpl", "updateAll", "Total Records updated = " + entity.size());
    }
    ...
    public List<Object> search(String finderName, Map<String, Object> fields, Map<String, String> fieldMetaData) throws Exception {
        ...
        Log.out.println("SHPRT324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ProductRepositoryImpl", "search", "Total Records Fetched = " + list.size());
        return list;
    }
    ...
    public Product findById(String productId) throws Exception {
        ...
        com.shop.app.shared.shoppingcontext.retail.Product listOfProduct = (com.shop.app.shared.shoppingcontext.retail.Product) query.getSingleResult();
        Log.out.println("SHPRT324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ProductRepositoryImpl", "findById", "Total Records Fetched = " + listOfProduct);
