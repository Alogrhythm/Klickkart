package com.shop.app.server.businessservice.appbasicsetup.usermanagement.aspect;
...
public class BusinessServiceusermanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.shop.app.server.businessservice.appbasicsetup.usermanagement..*(..))")
