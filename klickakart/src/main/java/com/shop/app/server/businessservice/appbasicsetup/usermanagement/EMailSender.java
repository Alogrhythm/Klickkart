package com.shop.app.server.businessservice.appbasicsetup.usermanagement;
...
public class EMailSender {
	...
	public boolean sendMail(String emailSubject, String emailBody, String receipent) throws Exception {
		...
		boolean emailStatus = sendEmail(properties, receipent);
		return emailStatus;
	}
	
	public boolean sendPassword(String emailBody, String receipent) throws Exception {
		Properties properties = new Properties();
		properties.put("mail.smtp.user", appConfig.getMailConfig().getUsername());
		properties.put("mail.smtp.host", appConfig.getMailConfig().getHost());
		properties.put("mail.smtp.port", appConfig.getMailConfig().getSmtpPort());
