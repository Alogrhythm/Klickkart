package com.shop.app.server.service.datavisualizer.clouddrive.aspect;
...
@Aspect
@Component
public class ServicecloudDriveAspect extends ServiceAspect {
   ...
   @Pointcut("execution(* com.athena.cloud..service..*(..))")
