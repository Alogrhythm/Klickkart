...
import com.shop.app.server.businessservice.shoppingcontext.retail.FetchCartItems;
...
public class FetchCartItemsWS {
    ...
    public HttpEntity<ResponseBean> fetchCartItems() throws Exception {
        ...
        java.util.List<com.shop.app.shared.shoppingcontext.FetchCartItems> _ruleOutput = fetchcartitems.fetchCartItems();
        responseBean.add("success", true);
        responseBean.add("message", "Successfully executed ");
        responseBean.add("data", _ruleOutput);
        Log.out.println(appAlarm.getAlarmID(), runtimeLogInfoHelper.getRequestHeaderBean(), "com.shop.app.server.businessservice.shoppingcontext.retail.FetchCartItems", "fetchCartItems");
