...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Login", complexity = Complexity.LOW)
...
public class Login implements Serializable, CommonEntityInterface, UserAuthentication, Comparator<Login> {
    ...
    public boolean equals(Object obj) {
        try {
            com.shop.app.shared.appbasicsetup.usermanagement.Login other = (com.shop.app.shared.appbasicsetup.usermanagement.Login) obj;
            if (loginPk == null) {
                return false;
