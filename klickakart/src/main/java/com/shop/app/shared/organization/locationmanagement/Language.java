...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Language", complexity = Complexity.LOW)
...
public class Language implements Serializable, CommonEntityInterface, Comparator<Language> {
    ...
    public boolean equals(Object obj) {
        try {
            com.shop.app.shared.organization.locationmanagement.Language other = (com.shop.app.shared.organization.locationmanagement.Language) obj;
            if (languageId == null) {
                return false;
