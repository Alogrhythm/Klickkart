...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "AppMenus", complexity = Complexity.LOW)
...
public class AppMenus implements Serializable, CommonEntityInterface, Comparator<AppMenus> {
    ...
    public boolean equals(Object obj) {
        try {
            com.shop.app.shared.appbasicsetup.userrolemanagement.AppMenus other = (com.shop.app.shared.appbasicsetup.userrolemanagement.AppMenus) obj;
            if (menuId == null) {
                return false;
