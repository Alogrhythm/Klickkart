...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Title", complexity = Complexity.LOW)
...
public class Title implements Serializable, CommonEntityInterface, Comparator<Title> {
    ...
    public boolean equals(Object obj) {
        try {
            com.shop.app.shared.organization.contactmanagement.Title other = (com.shop.app.shared.organization.contactmanagement.Title) obj;
            if (titleId == null) {
                return false;
