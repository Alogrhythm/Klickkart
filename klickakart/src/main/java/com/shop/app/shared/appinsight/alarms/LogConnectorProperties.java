...
public class LogConnectorProperties {
	...
	public String toString() {
		return "LogConnectorProperties [attributeComment=" + attributeComment + ", attributeName=" + attributeName + ", attributeValue=" + attributeValue
