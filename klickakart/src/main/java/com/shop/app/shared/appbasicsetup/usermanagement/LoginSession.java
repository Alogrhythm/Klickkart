...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "LoginSession", complexity = Complexity.LOW)
public class LoginSession implements Serializable, CommonEntityInterface, LoginSessionInterface, Comparator<LoginSession> {
    ...
    public boolean equals(Object obj) {
        try {
            com.shop.app.shared.appbasicsetup.usermanagement.LoginSession other = (com.shop.app.shared.appbasicsetup.usermanagement.LoginSession) obj;
            if (appSessionId == null) {
                return false;
