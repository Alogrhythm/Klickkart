...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "SessionData", complexity = Complexity.LOW)
...
public class SessionData implements Serializable, CommonEntityInterface, SessionDataInterface, Comparator<SessionData> {
    ...
    public boolean equals(Object obj) {
        try {
            com.shop.app.shared.appbasicsetup.usermanagement.SessionData other = (com.shop.app.shared.appbasicsetup.usermanagement.SessionData) obj;
            if (dataId == null) {
                return false;
