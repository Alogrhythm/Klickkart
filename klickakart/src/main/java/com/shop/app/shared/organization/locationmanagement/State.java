...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "State", complexity = Complexity.LOW)
...
public class State implements Serializable, CommonEntityInterface, Comparator<State> {
    ...
    public boolean equals(Object obj) {
        try {
            com.shop.app.shared.organization.locationmanagement.State other = (com.shop.app.shared.organization.locationmanagement.State) obj;
            if (stateId == null) {
                return false;
