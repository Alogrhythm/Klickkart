...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Gender", complexity = Complexity.LOW)
...
public class Gender implements Serializable, CommonEntityInterface, Comparator<Gender> {
    ...
    public boolean equals(Object obj) {
        try {
            com.shop.app.shared.organization.contactmanagement.Gender other = (com.shop.app.shared.organization.contactmanagement.Gender) obj;
            if (genderId == null) {
                return false;
