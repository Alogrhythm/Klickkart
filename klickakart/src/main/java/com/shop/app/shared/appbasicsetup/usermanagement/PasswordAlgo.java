...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "PasswordAlgo", complexity = Complexity.LOW)
...
public class PasswordAlgo implements Serializable, CommonEntityInterface, PasswordAlgoInterface, Comparator<PasswordAlgo> {
    ...
    public boolean equals(Object obj) {
        try {
            com.shop.app.shared.appbasicsetup.usermanagement.PasswordAlgo other = (com.shop.app.shared.appbasicsetup.usermanagement.PasswordAlgo) obj;
            if (algoId == null) {
                return false;
