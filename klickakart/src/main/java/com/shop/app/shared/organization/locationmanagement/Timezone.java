...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Timezone", complexity = Complexity.LOW)
...
public class Timezone implements Serializable, CommonEntityInterface, TimeZoneInterface, Comparator<Timezone> {
    ...
    public boolean equals(Object obj) {
        try {
            com.shop.app.shared.organization.locationmanagement.Timezone other = (com.shop.app.shared.organization.locationmanagement.Timezone) obj;
            if (timeZoneId == null) {
                return false;
