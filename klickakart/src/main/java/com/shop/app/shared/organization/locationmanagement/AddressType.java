package com.shop.app.shared.organization.locationmanagement;
...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "AddressType", complexity = Complexity.LOW)
...
public class AddressType implements Serializable, CommonEntityInterface, Comparator<AddressType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.shop.app.shared.organization.locationmanagement.AddressType other = (com.shop.app.shared.organization.locationmanagement.AddressType) obj;
            if (addressTypeId == null) {
                return false;
