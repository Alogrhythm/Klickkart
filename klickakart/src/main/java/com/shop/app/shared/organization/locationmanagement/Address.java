...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Address", complexity = Complexity.LOW)
...
public class Address implements Serializable, CommonEntityInterface, Comparator<Address> {
    ...
    public boolean equals(Object obj) {
        try {
            com.shop.app.shared.organization.locationmanagement.Address other = (com.shop.app.shared.organization.locationmanagement.Address) obj;
            if (addressId == null) {
                return false;
