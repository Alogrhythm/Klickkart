package com.shop.app.server.service;import java.math.BigDecimal;
...
public class RandomValueGenerator {
	...
	public String randomValueGenerate(String dataType, Integer maxValue,
			Integer minValue){
		StringBuilder sb = new StringBuilder();
		if (dataType.equalsIgnoreCase("varchar") || dataType.equalsIgnoreCase("String")
	...
	public BigDecimal getRandomBigDecimal(Double maxValue, Double minValue) {
		Random random = new Random();
		if (minValue != null && maxValue != null) {
			return new java.math.BigDecimal((random.nextDouble() * maxValue) + minValue);

		} else if (minValue != null && maxValue == null && minValue > 0) {
			return new java.math.BigDecimal((random.nextDouble() * minValue));

		} else if (maxValue != null && minValue == null) {

			return new java.math.BigDecimal((random.nextDouble() * maxValue));
		} else {
			return new java.math.BigDecimal(random.nextDouble());
		}
