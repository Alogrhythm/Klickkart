...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionIcon("Brff0cd4rCersVSsftpFZyC9Pl0nxfigD9Jf54lDWmHjeJSydR");
        question.setQuestion("K4KgXCM6hJzpWZljzqewmD134oYjym2G4SJG5PGyUqK8FYKPcK");
        question.setLevelid(1);
        question.setQuestionDetails("z2KkGWcZAG");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("UKzB96XhwkU8XoqdvoBfdu8r7wT1y1pl07DGquph7dLHVG8Fwp");
            question.setVersionId(1);
            question.setQuestion("2sd2URuugEH71nK3r7UdtYou3zD066AaYpwNphrPbqOluJt9S7");
            question.setLevelid(10);
            question.setQuestionDetails("Z50dlZXCiO");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "levelid", 13));
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 3, "question", null));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "ERczkRr1nkivAjaavUnhWHwMJz14F2qsqKNZ4FtMOnu4UlYfGNSueac0BbBENuGp4"));
